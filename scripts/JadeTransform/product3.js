        ...
        var promptProduct3Installation = {
            properties: {
                product3_installation: {
                    message: 'Do you want to install ' + configMongo.product3_installation + '?',
                    default: 'y',
                    required: false
                }
            }
                        ...
                        checkIfProductInstalled(result, function(flag){
                            if(flag){
                                var promptFlag = {
                                    properties: {
                                        flag: {
                                            message: configMongo.product3_installation + ' is already installed. Do you want to modify it?',
                                            default: 'y',
                                            required: false
                                        }
                                    }
