        ...
        var promptProduct4Installation = {
            properties: {
                product4_installation: {
                    message: 'Do you want to install ' + configMongo.product4_installation + '?',
                    default: 'y',
                    required: false
                }
            }
                        ...
                        checkIfProductInstalled(result, function(flag){
                            if(flag) {
                                var promptFlag = {
                                    properties: {
                                        flag: {
                                            message: configMongo.product4_installation + ' is already installed. Do you want to modify it?',
                                            default: 'y',
                                            required: false
                                        }
                                    }
