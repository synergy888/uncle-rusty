...
var mongo_transform = {
    ...
    populateTransformObjects: function(config){
        try {
            ...
            company.products_ticket_settings_company_timeZone_name = config.Companies_products_ticket_settings_company_timeZone_name;
            company.products_ticket_settings_company_timeZone_defaultRegion = config.Companies_products_ticket_settings_company_timeZone_defaultRegion;
            ...
            company.products_bulkticket_settings_company_timeZone_name = config.Companies_products_bulkticket_settings_company_timeZone_name;
            company.products_bulkticket_settings_company_timeZone_defaultRegion = config.Companies_products_bulkticket_settings_company_timeZone_defaultRegion;
            ...
            user.products_commerce_settings_timeZone_name = config.Users_products_commerce_settings_timeZone_name;
            user.products_commerce_settings_timeZone_defaultRegion = config.Users_products_commerce_settings_timeZone_defaultRegion;
            ...
            user.products_jobsite_settings_timeZone_name = config.Users_products_jobsite_settings_timeZone_name;
            user.products_jobsite_settings_timeZone_defaultRegion = config.Users_products_jobsite_settings_timeZone_defaultRegion;
